    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="px-6 py-20 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="aspect-[4/5] rounded-3xl bg-gray-200 flex items-center justify-center shadow-2xl overflow-hidden">
              <div className="text-center px-8">
                <p className="text-2xl font-semibold mb-2">Your Photo Here</p>
                <p className="text-gray-600">
                  Replace this section with a professional guitar photo or video.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-24">
        <div className="grid md:grid-cols-2 gap-14 items-start">
          ...
          <div className="bg-gray-50 rounded-3xl p-8 border border-gray-200">
            <h3 className="text-2xl font-semibold mb-6">What You’ll Improve</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
              <p className="text-gray-700 leading-relaxed mb-6">
                “Jaime helped me finally understand rhythm and timing. Lessons
                are structured, motivating, and very practical.”
              </p>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
              <p className="text-gray-700 leading-relaxed mb-6">
                “Very patient and incredibly knowledgeable. I improved more in
                a few months than I had in years teaching myself.”
              </p>
      ...
      <section id="pricing" className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="border-2 border-black rounded-3xl p-10 text-center shadow-xl">
            <div className="inline-block bg-black text-white px-4 py-1 rounded-full text-sm mb-5">
              Most Popular
            </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a
              ...
              className="bg-white text-black px-8 py-4 rounded-2xl text-lg font-medium hover:opacity-90 transition"
            >
              Email Me
            </a>
